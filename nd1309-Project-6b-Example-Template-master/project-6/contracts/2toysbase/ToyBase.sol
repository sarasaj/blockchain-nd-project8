...
contract ToyBase {
  ...
  State consku;  // Stock Keeping Unit (SKU)
  State defaultState = State.Designed;
  ...
  // Define a function 'prototypeToy' that allows a manufacturer to mark an item 'Approved'
  ...
  // Define a function 'sendToProduction' that allows a manufacturer to mark an item 'underProduction'
  ...
  // Define a function 'packToy' that allows a manufacturer to mark an item 'Packed'
  ...
  // Define a function 'sellToy' that allows a manufacturer to mark an item 'ForSale'
